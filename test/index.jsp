...
<%
    ...
    String title = "구남초등학교";
    int price = 25000;
    String description = "상태: 9/10, 직거래 선호, 물건에 하자 없고, 영수증 있음";
    int category = 4;
    int success = 1;
    String bid = "강동하";
    int hit = 43;
...
%>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b589ca52298076a814d3d36194e69ebe&libraries=services,clusterer"></script>
	<script>
...
var positions = [
    {
        ...
        content: '<div>아크로 리버</div><div>아크로 리버</div>',
